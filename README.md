...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/onnxmltools-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12219&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/onnxmltools-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `onnxmltools` can be installed with:

```
conda install onnxmltools
```

It is possible to list all of the versions of `onnxmltools` available on your platform with:
